module.exports = {
  ...
  sectionPage: {
    ...
    brandDesc1: 'BTcoin自2014年成立以來，全球超過上百萬高端用戶使用並作為他們的投資的主要平台。 BTcoin總部位於美國芝加哥，受到美國證券交易委員會（SEC），美國商品期貨交易委員會（CFTC），金融犯罪執法局（FinCEN），美國財政部海外資產管理辦公室（OFAC）監管，是目前全球著名的數字資產國際站。 BTcoin旨在向全球提供廣泛的數字貨幣交易、區塊鏈教育、區塊鏈項目孵化、區塊鏈資產發行平台、區塊鏈研究院以及區塊鏈公益慈善等服務。目前，用戶覆蓋全球207個國家和地區。 BTcoin自2014年創立，目前已經獲得UBS、Hotmail、BaiDu、Tesla、GoldmanInvestBank等世界頂級企業的投資。 BTcoin始終堅持將用戶利益放在第一位，致力於為全球高端投資者提供安全、公平、開放、高效的區塊鏈數字資產交易平台。',
    brandDesc2: 'BTcoin.COM定位於區塊鏈基礎服務商，致力於為全球用戶提供優質加密資產交易平台，秉承著“不作惡”的基本原則，堅持誠實、公正、熱情的服務於客戶，以開放的態度迎接一切有利於用戶根本利益的伙伴/項目。',
    gettingstart: '新手入門 | 極速買幣',
    officialstart: 'BTcoin官方新手入門輔助通道',
    oneminutebuy: '幣幣交易',
  ...
  activity: {
    ...
    attentiontxt4: '* 本活動最終解釋權歸幣嚴(WWW.BTcoin.club)官方所有',
    inputamount: '輸入兌換數量',
    ...
    submit: '提交',
    tipsmobile: '請進入電腦端頁面參與（WWW.BTcoin.club）',
    tipsmobile1: '請在電腦端打開（WWW.BTcoin.club）並進入創新實驗區參與',
    intvalue: '請輸入整數',
  ...
  invite: {
    ...
    partnerlevel: '合夥級別',
    ruledetail: '規則詳情',
    ruleprofile1: '幣嚴(WWW.BTcoin.club)的【推廣合夥人】是全網',
    ruleprofile2: '返佣比例最高、',
    ruleprofile3: '返佣時長最長(最高終身返佣)',
    ruleprofile4: '的推廣活動，讓付出相應努力的推廣者能夠成為真正意義上的平台“合夥人”,享受與幣嚴(WWW.BTcoin.club)交易平台共同成長的紅利！具體細則如下：',
    ruletext1: '一、為佈道數字資產理念與擴大用戶規模，幣嚴(WWW.BTcoin.club)推出【推廣合夥人】計劃，該活動長期有效。',
    ...
    thanks: '感謝您陪著幣嚴(WWW.BTcoin.club)一起成長！',
    headertip: '以上佣金數據非實時更新，系統每24H統計並更新一次。',
    ptools: '推廣工具箱',
    pt_title: '數字貨幣禮品卡',
    pt_desc: '兌換後自動成為下級好友，送朋友、送親人、送客戶、送夥伴。助力推廣合夥人更好推廣。',
    pt_more: '更多工具，敬請期待',
    pt_tips: '如果您有好的創意，請發送郵件至promotion@BTcoin.com，採納後有獎勵哦！',
    pt_card_amount: '卡面金額',
    ...
    pt_card_rule2: '二、免費禮品卡每個用戶限兌1份。由幣嚴(WWW.BTcoin.club)官方發放的免費禮品卡，每個用戶限兌一份，即使通過不同用戶領取到不同兌換碼的免費禮品卡，也只能兌換1份。自定義製作禮品卡不受此限制。',
    ...
    pt_card_rule6: '六、免費禮品卡最終解釋權歸BTcoin.COM所有。',
    pt_card_day: '天',
  ...
  description: {
    ...
    // message3: 'BTcoin數字資產交易平台支持每秒1000筆交易，給用戶帶來酣暢淋漓\n的交易體驗',
    title1: '金融級安全',
    title2: '極速充提',
    title3: '全球服務',
    title4: '嚴選資產',
    ...
    message5: '幣嚴(WWW.BTcoin.club)國際數字加密資產交易平台手機客戶端，專注掌上交易體驗',
    scanqrcode: '掃描二維碼，下載APP',
    aboutdesc1: '幣嚴(WWW.BTcoin.club)是技術全球領先的數字資產交易平台，註冊於芝加哥。幣嚴(WWW.BTcoin.club)核心成員來自於頂級互聯網和金融公司，大部分成員是深度比特幣和區塊鏈信仰者，我們深信區塊鏈將改變傳統壟斷性金融體系，會建立一個更加民主、自治的社會結構。',
    aboutdesc2: '幣嚴(WWW.BTcoin.club)平台擁有專業金融級別的交易架構，擁有自主研發的高並發內存撮合交易引擎，平台採用全冷充值錢包系統+多重簽名+高防護DDOS攻擊系統等交易架構，保證客戶資產安全。',
    aboutdesc3: '幣嚴(WWW.BTcoin.club)為了讓客戶更好的把握投資機會，客服部門內部採用扁平化管理，建立了極速服務響應機制，資產客服經理常年7*24H在線，為客戶提供資產充值提現等服務，保障客戶在25分鐘內完成資產充提。',
    aboutdesc4: '幣嚴(WWW.BTcoin.club)嚴格篩選優質項目並提供安全穩定的資產託管服務。幣嚴(WWW.BTcoin.club)秉承著“誠實、公正、熱情、開放”的理念，竭力為用戶打造安全、可靠、高效和友好的極致交易所。',
  ...
  bzb_description: {
    ...
    desc4: '參與BTcoin社區投票活動，包括但不限於上幣、回購等',
  ...
  index: {
    ...
    BHBregister: 'BTcoin賬戶註冊',
    tibi: '提幣到賬時間及限額',
    line_plane: 'BHB上線計劃、流通量及手續費返還公告',
    fenpeijizhi: '關於BTcoin收入分配機制的說明',
    jiangli_jihua: '邀請挖礦獎勵計劃',
    friend_fanhuan: '邀請好友、賺取額外手續費返還'
  },
  plate: {
    title: '平台收入分配方案 (BHB 持有者權益)',
    content1: '正如白皮書所描述的，BTcoin會拿出平台的80% (扣除稅費後) 的收入分配給BTcoin持有者，20%的收入用來支持平台的研發及運營。',
