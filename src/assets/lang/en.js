module.exports = {
  ...
  sectionPage: {
    ...
    brandTitle: 'About BTcoin',
    brandDetail: 'Honest  |  Fair  |  Enthusiasm  |  Open',
    brandDesc1: 'Since its establishment in 2014, BTcoin has been used by millions of high-end users worldwide as the main platform for their investment. BTcoin is headquartered in Chicago, USA, and is regulated by the US Securities and Exchange Commission (SEC), the US Commodity Futures Trading Commission (CFTC), the Financial Crimes Enforcement Agency (FinCEN), and the Office of Overseas Asset Management (OFAC) of the US Department of the Treasury. It is currently a world-renowned number Asset International Station. BTcoin aims to provide a wide range of services such as digital currency transactions, blockchain education, blockchain project incubation, blockchain asset issuance platform, blockchain research institute, and blockchain charity to the world. Currently, users cover 207 countries and regions around the world. Since its establishment in 2014, BTcoin has received investment from world-class companies such as UBS, Hotmail, BaiDu, Tesla, and GoldmanInvestBank. BTcoin always insists on putting the interests of users first, and is committed to providing a safe, fair, open and efficient blockchain digital asset trading platform for high-end investors around the world.',
    brandDesc2: 'BTcoin is located in the basic service provider of block chain, dedicated to providing high-quality encrypted assets trading platform for global users, adhering to the basic principle of “DO NOT BE EVIL”, upholding honest, fair and enthusiastic service to customers, and welcoming all partners/projects that are beneficial to the fundamental interests of users with an open attitude.',
    gettingstart: "HOT | Beginner's Guide",
    officialstart: 'BTcoin Official Customer Service',
  ...
  ctc: {
    ...
    desc: 'Crypto assets are managed by BTcoin, and the acceptor provides exchange services for exchange.',
    buyin: 'Buy',
    sell: 'Sell',
    buyprice: 'Buy Price',
    sellprice: 'Sell Price',
  ...
  activity: {
    ...
    attentiontxt4: '* The right of final interpretation of this activity belongs to the official ownership of BTcoin.',
    ...
    submit: 'Submit',
    tipsmobile: 'Please use PC web（WWW.BTcoin.club）',
  ...
  invite: {
    ...
    ruleprofile1: '[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with BTcoin trading platform. Detailed rules are as follows:',
    ruleprofile2: '',
    ruleprofile3: '',
    ruleprofile4: '',
    ruletext1: '1、In order to preach the concept of digital assets and expand the scale of users, BTcoin launched the “Promotion Partner” program, which is effective for a long time.',
    ...
    ruletext11: '11、The right of final interpretation of this activity belongs to BTcoin.',
    ...
    thanks: 'Thank you for supporting BTcoin！',
    ...
    pt_tips: 'If you have a good idea, please send an email to promotion@BTcoin.com, with a reward after adoption.！',
    ...
    pt_card_rule6: '6. The right of final interpretation of free gift cards belongs to BTcoin.COM.',
    pt_card_day: 'Days',
  ...
  uc: {
    ...
    identity: {
      ...
      become: 'Become BTcoin Certified Business and enjoy more transaction privileges',
  ...
  cms: {
    ...
    download: 'Download',
    downloadslogan: 'BTcoin APP - Trade everywhere.'
  },
  description: {
    title1: 'Security',
    title2: '24H Service',
    ...
    aboutdesc1: 'Since its establishment in 2014, BTcoin has been used by millions of high-end users worldwide as the main platform for their investment. BTcoin is headquartered in Chicago, USA, and is regulated by the US Securities and Exchange Commission (SEC), the US Commodity Futures Trading Commission (CFTC), the Financial Crimes Enforcement Agency (FinCEN), and the Office of Overseas Asset Management (OFAC) of the US Department of the Treasury. It is currently a world-renowned number Asset International Station. BTcoin aims to provide a wide range of services such as digital currency transactions, blockchain education, blockchain project incubation, blockchain asset issuance platform, blockchain research institute, and blockchain charity to the world. Currently, users cover 207 countries and regions around the world. Since its establishment in 2014, BTcoin has received investment from world-class companies such as UBS, Hotmail, BaiDu, Tesla, and GoldmanInvestBank. BTcoin always insists on putting the interests of users first, and is committed to providing a safe, fair, open and efficient blockchain digital asset trading platform for high-end investors around the world.',
    aboutdesc2: 'BTcoin is located in the basic service provider of block chain, dedicated to providing high-quality encrypted assets trading platform for global users, adhering to the basic principle of “DO NOT BE EVIL”, upholding honest, fair and enthusiastic service to customers, and welcoming all partners/projects that are beneficial to the fundamental interests of users with an open attitude.',
    support: 'Support',
    report: 'Suggestion',
    service: 'Customer Service',
    apply: 'Board Apply',
    coop: 'Cooperation',
    community: 'BTcoin Community',
    wechat: 'Wechat',
  ...
  index: {
    ...
    BHBregister: 'BTcoin account registration',
    ...
    fenpeijizhi: 'A description of the BTcoin income distribution mechanism',
  ...
  plate: {
    ...
    content1: 'As described in the white paper, BTcoin will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.',
