module.exports = {
  ...
  sectionPage: {
    ...
    brandDesc1: 'С момента своего создания в 2014 году, BTcoin использовался миллионами высокопроизводительных пользователей по всему миру в качестве основной платформы для своих инвестиций. BTcoin со штаб-квартирой в Чикаго, США, регулируется Комиссией по ценным бумагам и биржам США (SEC), Комиссией по торговле товарными фьючерсами США (CFTC), Агентством по борьбе с финансовыми преступлениями (FinCEN) и Управлением по управлению зарубежными активами (OFAC). ) Министерства финансов США. В настоящее время это всемирно известная станция Asset International. BTcoin стремится предоставлять широкий спектр услуг, таких как транзакции с цифровой валютой, обучение блокчейну, инкубация блокчейн-проектов, платформа для выпуска активов блокчейна, исследовательский институт блокчейнов и благотворительность блокчейн для всего мира. В настоящее время пользователи работают в 207 странах и регионах по всему миру. С момента своего создания в 2014 году BTcoin получил инвестиции от таких компаний мирового уровня, как UBS, Hotmail, BaiDu, Tesla и GoldmanInvestBank. BTcoin всегда настаивает на том, чтобы интересы пользователей были превыше всего, и стремится предоставить безопасную, справедливую, открытую и эффективную платформу для торговли цифровыми активами на блокчейне для высококлассных инвесторов по всему миру.',
  ...
  otc: {
    ...
    index: {
      ...
      bot1_tip: 'Команда с более чем 10-летним опытом управления финансовыми рисками занимается \n настраиваемой системой стратегии безопасности',
