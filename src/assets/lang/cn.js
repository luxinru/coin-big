module.exports = {
  ...
  sectionPage: {
    ...
    brandDesc1: 'BTcoin自2014年成立以来，全球超过上百万高端用户使用并作为他们的投资的主要平台。BTcoin总部位于美国芝加哥，受到美国证券交易委员会（SEC），美国商品期货交易委员会（CFTC），金融犯罪执法局（FinCEN），美国财政部海外资产管理办公室（OFAC）监管，是目前全球著名的数字资产国际站。BTcoin旨在向全球提供广泛的数字货币交易、区块链教育、区块链项目孵化、区块链资产发行平台、区块链研究院以及区块链公益慈善等服务。目前，用户覆盖全球207个国家和地区。BTcoin自2014年创立，目前已经获得UBS、Hotmail、BaiDu、Tesla、GoldmanInvestBank等世界顶级企业的投资。BTcoin始终坚持将用户利益放在第一位，致力于为全球高端投资者提供安全、公平、开放、高效的区块链数字资产交易平台。',
    brandDesc2: 'WWW.BTcoin.club定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。',
    gettingstart: '新手入门 | 极速买币',
    officialstart: 'BTcoin官方新手入门辅助通道',
    oneminutebuy: '币币交易',
  ...
  activity: {
    ...
    attentiontxt4: '* 本活动最终解释权归BTcoin(WWW.BTcoin.club)官方所有',
    inputamount: '输入兑换数量',
    ...
    submit: '提交',
    tipsmobile: '请进入电脑端页面参与（WWW.BTcoin.club）',
    tipsmobile1: '请在电脑端打开（WWW.BTcoin.club）并进入创新实验区参与',
    intvalue: '请输入整数',
  ...
  invite: {
    ...
    partnerlevel: '合伙级别',
    ruledetail: '规则详情',
    ruleprofile1: 'BTcoin(WWW.BTcoin.club)的【推广合伙人】是全网',
    ruleprofile2: '返佣比例最高、',
    ruleprofile3: '返佣时长最长(最高终身返佣)',
    ruleprofile4: '的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与BTcoin(WWW.BTcoin.club)交易平台共同成长的红利！具体细则如下：',
    ruletext1: '一、为布道数字资产理念与扩大用户规模，BTcoin(WWW.BTcoin.club)推出【推广合伙人】计划，该活动长期有效。',
    ...
    ruletext8: '八、推广返佣排行榜TOP10或TOP100不定期会获得由BTcoin(WWW.BTcoin.club)官方发放的额外奖励。',
    ruletext9: '九、如其他活动与【推广合伙人】活动冲突，则经协商后决定是否临时变更，望诸合伙人谅解。',
    ruletext10: '十、L4(巡抚)、L5(太守)、L6(节度使)级合伙人分别享受每年返佣总额的5%、10%、15%的分红奖励。',
    ruletext11: '十一、本活动最终解释权归BTcoin(WWW.BTcoin.club)所有。',
    ...
    thanks: '感谢您陪着BTcoin(WWW.BTcoin.club)一起成长！',
    ...
    pt_card_rule2: '二、免费礼品卡每个用户限兑1份。由BTcoin(WWW.BTcoin.club)官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。',
    ...
    pt_card_rule6: '六、免费礼品卡最终解释权归WWW.BTcoin.club所有。',
    pt_card_day: '天',
  ...
  cms: {
    ...
    scanforshare: '扫一扫分享',
    download: '立即下载',
    downloadslogan: 'BTcoinAPP - 全球数字资产交易平台'
  },
  description: {
    ...
    message5: 'BTcoin(WWW.BTcoin.club)国际数字加密资产交易平台手机客户端，专注掌上交易体验',
    scanqrcode: '扫描二维码，下载APP',
    aboutdesc1: 'BTcoin(WWW.BTcoin.club)是技术全球领先的数字资产交易平台，注册于开曼群岛，核心运营团队位于香港。BTcoin(WWW.BTcoin.club)核心成员来自于顶级互联网和金融公司，大部分成员是深度比特币和区块链信仰者，我们深信区块链将改变传统垄断性金融体系，会建立一个更加民主、自治的社会结构。',
    aboutdesc2: 'BTcoin(WWW.BTcoin.club)平台拥有专业金融级别的交易架构，拥有自主研发的高并发内存撮合交易引擎，平台采用全冷充值钱包系统+多重签名+高防护DDOS攻击系统等交易架构，保证客户资产安全。',
    aboutdesc3: 'BTcoin(WWW.BTcoin.club)为了让客户更好的把握投资机会，客服部门内部采用扁平化管理，建立了极速服务响应机制，资产客服经理常年7*24H在线，为客户提供资产充值提现等服务，保障客户在25分钟内完成资产充提。',
    aboutdesc4: 'BTcoin(WWW.BTcoin.club)严格筛选优质项目并提供安全稳定的资产托管服务。BTcoin(WWW.BTcoin.club)秉承着“诚实、公正、热情、开放”的理念，竭力为用户打造安全、可靠、高效和友好的极致交易所。',
  ...
  bzb_description: {
    ...
    desc4: '参与BTcoin社区投票活动，包括但不限于上币、回购等',
  ...
  index: {
    ...
    BHBregister: 'BTcoin账户注册',
    tibi: '提币到账时间及限额',
    line_plane: 'BHB上线计划、流通量及手续费返还公告',
    fenpeijizhi: '关于BTcoin收入分配机制的说明',
    jiangli_jihua: '邀请挖矿奖励计划',
    friend_fanhuan: '邀请好友、赚取额外手续费返还'
  },
  plate: {
    title: '平台收入分配方案 (BHB 持有者权益)',
    content1: '正如白皮书所描述的，BTcoin会拿出平台的80% (扣除税费后) 的收入分配给BTcoin持有者，20%的收入用来支持平台的研发及运营。',
